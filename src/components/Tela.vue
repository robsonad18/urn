    ...
    <div class="urna-tela">
        <div v-if="tela != 'fim'" class="urna-tela-voto">
            <div class="urna-tela-voto-textos">
                <div class="urna-tela-voto-titulo">
                    Seu voto para:
                </div>
                ...
                <div class="urna-tela-voto-descricao">
                    Nome: <strong>{{ candidato.nome ? candidato.nome : '_______' }}</strong>
                </div>
                <div class="urna-tela-voto-descricao">
                    Partido: <strong>{{ candidato.partido ? candidato.partido : '_______' }}</strong>
                </div>
                <!-- <div class="urna-tela-voto-descricao">
                    Nome: <strong>{{ candidato.nome ? candidato.nome : '_______' }}</strong>
                </div> -->
